...
%rule words(begin, word_list)
                : begin ' '+ word_list tSTRING_END
                    {
                        $$ = make_list($3, &@$);
                    {VALUE v1=get_value($:3), v2=dispatch1(array,v1); p->s_lvalue=v2;}
                    }
                ;
...
begin_block	: block_open top_compstmt '}'
                    {
                        ...
                        p->eval_tree_begin = block_append(p, p->eval_tree_begin,
                                                          NEW_BEGIN($2, &@$));
                        $$ = NEW_BEGIN(0, &@$);
                    {VALUE v1=get_value($:2), v2=dispatch1(BEGIN,v1); p->s_lvalue=v2;}
                    }
                ;
...
stmt		: keyword_alias fitem {SET_LEX_STATE(EXPR_FNAME|EXPR_FITEM);} fitem
                    {
                        $$ = NEW_ALIAS($2, $4, &@$, &@1);
                    {VALUE v1=get_value($:2), v2=get_value($:4), v3=dispatch2(alias,v1,v2); p->s_lvalue=v3;}
                    }
                | keyword_alias tGVAR tGVAR
                    {
                        $$ = NEW_VALIAS($2, $3, &@$, &@1);
                    {VALUE v1=get_value($:2), v2=get_value($:3), v3=dispatch2(var_alias,v1,v2); p->s_lvalue=v3;}
                    }
...
#endif
                        $$ = NEW_ERROR(&@$);
                    {VALUE v1=get_value($:3), v2=ERR_MESG(), v3=dispatch2(alias_error,v2,v1); p->s_lvalue=v3;ripper_error(p);}
                    }
                | keyword_undef undef_list
                    {
                        ...
                        $$ = $2;
                    {VALUE v1=get_value($:2), v2=dispatch1(undef,v1); p->s_lvalue=v2;}
                    }
                ...
                | stmt modifier_while expr_value
                    ...
                    {VALUE v1=get_value($:3), v2=get_value($:1), v3=dispatch2(while_mod,v1,v2); p->s_lvalue=v3;}
                    }
                | stmt modifier_until expr_value
                    ...
                    {VALUE v1=get_value($:3), v2=get_value($:1), v3=dispatch2(until_mod,v1,v2); p->s_lvalue=v3;}
                    }
                ...
                | k_END allow_exits '{' compstmt '}'
                    ...
                    {VALUE v1=get_value($:compstmt), v2=dispatch1(END,v1); p->s_lvalue=v2;}
                    }
                | command_asgn
                | mlhs '=' lex_ctxt command_call
                    ...
                    {VALUE v1=get_value($:1), v2=get_value($:4), v3=dispatch2(massign,v1,v2); p->s_lvalue=v3;}
                    }
                | lhs '=' lex_ctxt mrhs
                    {
                        $$ = node_assign(p, $1, $4, $3, &@$);
                ...
                | mlhs '=' lex_ctxt mrhs_arg modifier_rescue
                  after_rescue stmt[resbody]
                    ...
                    {VALUE v1=get_value($:1), v2=get_value($:4), v3=get_value($:7), v4=dispatch2(rescue_mod,v2,v3), v5=dispatch2(massign,v1,v4); p->s_lvalue=v5;}
                    }
...
command_asgn	: lhs '=' lex_ctxt command_rhs
                ...
                | var_lhs tOP_ASGN lex_ctxt command_rhs
                    ...
                    {VALUE v1=get_value($:1), v2=get_value($:2), v3=get_value($:4), v4=dispatch3(opassign,v1,v2,v3); p->s_lvalue=v4;}
                    }
                | primary_value '[' opt_call_args rbracket tOP_ASGN lex_ctxt command_rhs
                    {
                        $$ = new_ary_op_assign(p, $1, $3, $5, $7, &@3, &@$, &NULL_LOC, &@2, &@4, &@5);
                    {VALUE v1=get_value($:1), v2=get_value($:3), v3=get_value($:5), v4=get_value($:7), v5=dispatch2(aref_field,v1,v2), v6=dispatch3(opassign,v5,v3,v4); p->s_lvalue=v6;}
                ...
                | primary_value tCOLON2 tCONSTANT tOP_ASGN lex_ctxt command_rhs
                    ...
                    {VALUE v1=get_value($:1), v2=get_value($:3), v3=get_value($:4), v4=get_value($:6), v5=dispatch2(const_path_field,v1,v2), v6=dispatch3(opassign,v5,v3,v4); p->s_lvalue=v6;}
                    }
                ...
                | backref tOP_ASGN lex_ctxt command_rhs
                    {
                        ...
                        $$ = NEW_ERROR(&@$);
                    {VALUE v1=get_value($:1), v2=get_value($:2), v3=get_value($:4), v4=dispatch1(var_field,v1), v5=dispatch3(opassign,v4,v2,v3), v6=e, v7=dispatch2(assign_error,v6,v5); p->s_lvalue=v7;ripper_error(p);}
                    }
                ;
...
expr		: command_call
                | expr keyword_and expr
                    {
                        $$ = logop(p, idAND, $1, $3, &@2, &@$);
                    {VALUE v1=get_value($:1), v2=get_value($:3), v3=ID2VAL(idAND), v4=dispatch3(binary,v1,v3,v2); p->s_lvalue=v4;}
                    }
                | expr keyword_or expr
                    {
                        $$ = logop(p, idOR, $1, $3, &@2, &@$);
                    {VALUE v1=get_value($:1), v2=get_value($:3), v3=ID2VAL(idOR), v4=dispatch3(binary,v1,v3,v2); p->s_lvalue=v4;}
                    }
                | keyword_not '\n'? expr
                    {
                        $$ = call_uni_op(p, method_cond(p, $3, &@3), METHOD_NOT, &@1, &@$);
...
primary         : inline_primary
                ...
                | tFID
                    {
                        $$ = (NODE *)NEW_FCALL($1, 0, &@$);
                    {VALUE v1=get_value($:1), v2=dispatch1(fcall,v1), v3=dispatch0(args_new), v4=dispatch2(method_add_arg,v2,v3); p->s_lvalue=v4;}
                    }
                | k_begin
                    {
                        CMDARG_PUSH(0);
                ...
                | tLBRACK aref_args ']'
                    {
                        $$ = make_list($2, &@$);
                    {VALUE v1=get_value($:2), v2=dispatch1(array,v1); p->s_lvalue=v2;}
                    }
                | tLBRACE assoc_list '}'
                    {
                        $$ = new_hash(p, $2, &@$);
                        RNODE_HASH($$)->nd_brace = TRUE;
                    {VALUE v1=get_value($:2), v2=dispatch1(hash,v1); p->s_lvalue=v2;}
                    }
                | k_return
                    {
                        $$ = NEW_RETURN(0, &@$, &@1);
                ...
                | k_yield '(' call_args rparen
                    {
                        $$ = new_yield(p, $3, &@$);
                    {VALUE v1=get_value($:3), v2=dispatch1(paren,v1), v3=dispatch1(yield,v2); p->s_lvalue=v3;}
                    }
                | k_yield '(' rparen
                    {
                        $$ = NEW_YIELD(0, &@$);
                ...
                | keyword_defined '\n'? '(' begin_defined expr rparen
                    {
                        ...
                        $$ = new_defined(p, $5, &@$);
                    {VALUE v1=get_value($:5), v2=dispatch1(defined,v1); p->s_lvalue=v2;}
                    }
                ...
                | fcall brace_block
                    ...
                    {VALUE v1=get_value($:1), v2=get_value($:2), v3=dispatch1(fcall,v1), v4=dispatch0(args_new), v5=dispatch2(method_add_arg,v3,v4), v6=dispatch2(method_add_block,v5,v2); p->s_lvalue=v6;}
                    }
                | method_call
                  ...
                  k_end
                    {
                        $$ = new_if(p, $2, $4, $5, &@$);
                        fixpos($$, $2);
                    {VALUE v1=get_value($:2), v2=get_value($:4), v3=get_value($:5), v4=dispatch3(if,v1,v2,v3); p->s_lvalue=v4;}
                    }
                  ...
                  k_end
                    {
                        ...
                        fixpos($$, $2);
                    {VALUE v1=get_value($:2), v2=get_value($:4), v3=get_value($:5), v4=dispatch3(unless,v1,v2,v3); p->s_lvalue=v4;}
                    }
                  ...
                  k_end
                    {
                        ...
                        fixpos($$, $2);
                    {VALUE v1=get_value($:2), v2=get_value($:3), v3=dispatch2(while,v1,v2); p->s_lvalue=v3;}
                    }
                  ...
                  k_end
                    {
                        ...
                        fixpos($$, $2);
                    {VALUE v1=get_value($:2), v2=get_value($:3), v3=dispatch2(until,v1,v2); p->s_lvalue=v3;}
                    }
                  ...
                  k_end
                    {
                        ...
                        $$ = NEW_CASE($2, $5, &@$, &@1, &@6);
                        fixpos($$, $2);
                    {VALUE v1=get_value($:2), v2=get_value($:5), v3=dispatch2(case,v1,v2); p->s_lvalue=v3;}
                    }
                | k_case terms?
                    {
                        $$ = p->case_labels;
                  ...
                  k_end
                    {
                        ...
                        p->case_labels = $3;
                        $$ = NEW_CASE2($4, &@$, &@1, &@5);
                    {VALUE v1=get_value($:4), v2=Qnil, v3=dispatch2(case,v2,v1); p->s_lvalue=v3;}
                    }
                | k_case expr_value terms?
                  p_case_body
                  k_end
                    {
                        $$ = NEW_CASE3($2, $4, &@$, &@1, &@5);
                    {VALUE v1=get_value($:2), v2=get_value($:4), v3=dispatch2(case,v1,v2); p->s_lvalue=v3;}
                    }
                  ...
                  k_end
                    {
                        ...
                        $$ = NEW_FOR($4, scope, &@$);
                        fixpos($$, $2);
                    {VALUE v1=get_value($:2), v2=get_value($:4), v3=get_value($:5), v4=dispatch3(for,v1,v2,v3); p->s_lvalue=v4;}
                    }
...
block_param	: f_arg ',' f_optarg(primary_value) ',' f_rest_arg opt_args_tail(block_args_tail)
                    ...
                    {VALUE v1=get_value($:1), v2=get_value($:3), v3=get_value($:5), v4=get_value($:6), v5=rb_ary_entry(v4, 0), v6=rb_ary_entry(v4, 1), v7=rb_ary_entry(v4, 2), v8=Qnil, v9=dispatch7(params,v1,v2,v3,v8,v5,v6,v7); p->s_lvalue=v9;}
                    }
                | f_arg ',' f_optarg(primary_value) ',' f_rest_arg ',' f_arg opt_args_tail(block_args_tail)
                    {
                        $$ = new_args(p, $1, $3, $5, $7, $8, &@$);
                    {VALUE v1=get_value($:1), v2=get_value($:3), v3=get_value($:5), v4=get_value($:7), v5=get_value($:8), v6=rb_ary_entry(v5, 0), v7=rb_ary_entry(v5, 1), v8=rb_ary_entry(v5, 2), v9=dispatch7(params,v1,v2,v3,v4,v6,v7,v8); p->s_lvalue=v9;}
                    }
                | f_arg ',' f_optarg(primary_value) opt_args_tail(block_args_tail)
                    {
                        $$ = new_args(p, $1, $3, 0, 0, $4, &@$);
                    {VALUE v1=get_value($:1), v2=get_value($:3), v3=get_value($:4), v4=rb_ary_entry(v3, 0), v5=rb_ary_entry(v3, 1), v6=rb_ary_entry(v3, 2), v7=Qnil, v8=Qnil, v9=dispatch7(params,v1,v2,v7,v8,v4,v5,v6); p->s_lvalue=v9;}
                    }
                | f_arg ',' f_optarg(primary_value) ',' f_arg opt_args_tail(block_args_tail)
                    {
                        $$ = new_args(p, $1, $3, 0, $5, $6, &@$);
                    {VALUE v1=get_value($:1), v2=get_value($:3), v3=get_value($:5), v4=get_value($:6), v5=rb_ary_entry(v4, 0), v6=rb_ary_entry(v4, 1), v7=rb_ary_entry(v4, 2), v8=Qnil, v9=dispatch7(params,v1,v2,v8,v3,v5,v6,v7); p->s_lvalue=v9;}
                    }
                | f_arg ',' f_rest_arg opt_args_tail(block_args_tail)
                    {
                        $$ = new_args(p, $1, 0, $3, 0, $4, &@$);
                    {VALUE v1=get_value($:1), v2=get_value($:3), v3=get_value($:4), v4=rb_ary_entry(v3, 0), v5=rb_ary_entry(v3, 1), v6=rb_ary_entry(v3, 2), v7=Qnil, v8=Qnil, v9=dispatch7(params,v1,v7,v2,v8,v4,v5,v6); p->s_lvalue=v9;}
                    }
                | f_arg excessed_comma
                    {
                        $$ = new_args_tail(p, 0, 0, 0, &@2);
                        $$ = new_args(p, $1, 0, $2, 0, $$, &@$);
                    {VALUE v1=get_value($:1), v2=get_value($:2), v3=Qnil, v4=Qnil, v5=Qnil, v6=Qnil, v7=Qnil, v8=dispatch7(params,v1,v3,v2,v4,v5,v6,v7); p->s_lvalue=v8;}
                    }
                | f_arg ',' f_rest_arg ',' f_arg opt_args_tail(block_args_tail)
                    {
                        $$ = new_args(p, $1, 0, $3, $5, $6, &@$);
                    {VALUE v1=get_value($:1), v2=get_value($:3), v3=get_value($:5), v4=get_value($:6), v5=rb_ary_entry(v4, 0), v6=rb_ary_entry(v4, 1), v7=rb_ary_entry(v4, 2), v8=Qnil, v9=dispatch7(params,v1,v8,v2,v3,v5,v6,v7); p->s_lvalue=v9;}
                    }
                | f_arg opt_args_tail(block_args_tail)
                    {
                        $$ = new_args(p, $1, 0, 0, 0, $2, &@$);
                    {VALUE v1=get_value($:1), v2=get_value($:2), v3=rb_ary_entry(v2, 0), v4=rb_ary_entry(v2, 1), v5=rb_ary_entry(v2, 2), v6=Qnil, v7=Qnil, v8=Qnil, v9=dispatch7(params,v1,v6,v7,v8,v3,v4,v5); p->s_lvalue=v9;}
                    }
                | f_optarg(primary_value) ',' f_rest_arg opt_args_tail(block_args_tail)
                    {
                        $$ = new_args(p, 0, $1, $3, 0, $4, &@$);
                    {VALUE v1=get_value($:1), v2=get_value($:3), v3=get_value($:4), v4=rb_ary_entry(v3, 0), v5=rb_ary_entry(v3, 1), v6=rb_ary_entry(v3, 2), v7=Qnil, v8=Qnil, v9=dispatch7(params,v7,v1,v2,v8,v4,v5,v6); p->s_lvalue=v9;}
                    }
                | f_optarg(primary_value) ',' f_rest_arg ',' f_arg opt_args_tail(block_args_tail)
                    {
                        $$ = new_args(p, 0, $1, $3, $5, $6, &@$);
                    {VALUE v1=get_value($:1), v2=get_value($:3), v3=get_value($:5), v4=get_value($:6), v5=rb_ary_entry(v4, 0), v6=rb_ary_entry(v4, 1), v7=rb_ary_entry(v4, 2), v8=Qnil, v9=dispatch7(params,v8,v1,v2,v3,v5,v6,v7); p->s_lvalue=v9;}
                    }
                | f_optarg(primary_value) opt_args_tail(block_args_tail)
                    {
                        $$ = new_args(p, 0, $1, 0, 0, $2, &@$);
                    {VALUE v1=get_value($:1), v2=get_value($:2), v3=rb_ary_entry(v2, 0), v4=rb_ary_entry(v2, 1), v5=rb_ary_entry(v2, 2), v6=Qnil, v7=Qnil, v8=Qnil, v9=dispatch7(params,v6,v1,v7,v8,v3,v4,v5); p->s_lvalue=v9;}
                    }
                | f_optarg(primary_value) ',' f_arg opt_args_tail(block_args_tail)
                    {
                        $$ = new_args(p, 0, $1, 0, $3, $4, &@$);
                    {VALUE v1=get_value($:1), v2=get_value($:3), v3=get_value($:4), v4=rb_ary_entry(v3, 0), v5=rb_ary_entry(v3, 1), v6=rb_ary_entry(v3, 2), v7=Qnil, v8=Qnil, v9=dispatch7(params,v7,v1,v8,v2,v4,v5,v6); p->s_lvalue=v9;}
                    }
                | f_rest_arg opt_args_tail(block_args_tail)
                    {
                        $$ = new_args(p, 0, 0, $1, 0, $2, &@$);
                    {VALUE v1=get_value($:1), v2=get_value($:2), v3=rb_ary_entry(v2, 0), v4=rb_ary_entry(v2, 1), v5=rb_ary_entry(v2, 2), v6=Qnil, v7=Qnil, v8=Qnil, v9=dispatch7(params,v6,v7,v1,v8,v3,v4,v5); p->s_lvalue=v9;}
                    }
                | f_rest_arg ',' f_arg opt_args_tail(block_args_tail)
                    {
                        $$ = new_args(p, 0, 0, $1, $3, $4, &@$);
                    {VALUE v1=get_value($:1), v2=get_value($:3), v3=get_value($:4), v4=rb_ary_entry(v3, 0), v5=rb_ary_entry(v3, 1), v6=rb_ary_entry(v3, 2), v7=Qnil, v8=Qnil, v9=dispatch7(params,v7,v8,v1,v2,v4,v5,v6); p->s_lvalue=v9;}
                    }
                | block_args_tail
                    {
                        $$ = new_args(p, 0, 0, 0, 0, $1, &@$);
                    {VALUE v1=get_value($:1), v2=rb_ary_entry(v1, 0), v3=rb_ary_entry(v1, 1), v4=rb_ary_entry(v1, 2), v5=Qnil, v6=Qnil, v7=Qnil, v8=Qnil, v9=dispatch7(params,v5,v6,v7,v8,v2,v3,v4); p->s_lvalue=v9;}
                    }
                ;
...
block_param_def	: '|' opt_bv_decl '|'
                    {
                        ...
                        p->ctxt.in_argdef = 0;
                        $$ = 0;
                    {VALUE v1=get_value($:2), v2=Qnil, v3=Qnil, v4=Qnil, v5=Qnil, v6=Qnil, v7=Qnil, v8=Qnil, v9=dispatch7(params,v2,v3,v4,v5,v6,v7,v8), v10=dispatch2(block_var,v9,v1); p->s_lvalue=v10;}
                    }
                | '|' block_param opt_bv_decl '|'
                    {
                        ...
                        p->ctxt.in_argdef = 0;
                        $$ = $2;
                    {VALUE v1=get_value($:2), v2=get_value($:3), v3=dispatch2(block_var,v1,v2); p->s_lvalue=v3;}
                    }
                ;
...
block_call	: command do_block
                ...
                | block_call call_op2 operation2 opt_paren_args brace_block
                    ...
                    {VALUE v1=get_value($:1), v2=get_value($:2), v3=get_value($:3), v4=get_value($:4), v5=dispatch4(command_call,v1,v2,v3,v4); p->s_lvalue=v5;}
                        if ($5) {
                        {VALUE v1=get_value($:5), v2=p->s_lvalue, v3=dispatch2(method_add_block,v2,v1); p->s_lvalue=v3;}
                        }
                    }
...
p_expr_basic	: p_value
                ...
                | p_const '[' rbracket
                    ...
                    {VALUE v1=get_value($:1), v2=Qnil, v3=Qnil, v4=Qnil, v5=dispatch4(aryptn,v1,v2,v3,v4); p->s_lvalue=v5;}
                    }
                  ...
                  string_dvar
                    {
                        ...
                        $$ = NEW_EVSTR($3, &@$);
                        nd_set_line($$, @3.end_pos.lineno);
                    {VALUE v1=get_value($:3), v2=dispatch1(string_dvar,v1); p->s_lvalue=v2;}
                    }
                | tSTRING_DBEG[state]
                    {
                        CMDARG_PUSH(0);
...
f_kw		: f_label arg_value
                    ...
                    {VALUE v1=get_value($:2); p->s_lvalue=rb_ary_new_from_args(2, p->s_lvalue, v1);}
                    }
                | f_label
                    {
                        p->ctxt.in_argdef = 1;
